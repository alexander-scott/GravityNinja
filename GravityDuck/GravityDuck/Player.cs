...
namespace GravityDuck
{
	...
	public class Player
	{
		...
		public static Vector2 		directionVector = new Vector2(1.0f, 1.0f); //This is the direction the player will move. It will change relative to the angle of the maze
		...
		public void Update2(Vector2 gravity, Vector2 rotate)
		{		
		...
		public void Update(Vector2 gravity, Vector2 bounceVector, float bounce, Vector2 rotate)
		{		
			...
			Vector2 tempDir;
			if (bounce > 0)
				tempDir = new Vector2(bounceVector.X, bounceVector.Y);
			else 
				tempDir = new Vector2(gravity.X, gravity.Y);
